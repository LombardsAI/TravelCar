           ...
           $id = $mv->getNPlaque()."&".$mv->getClient();
            printf(
                "<tr id='$id'>"
                    ...
                    . "<td>%s</td>"
                    . "<td>%s</td>"
                    . "<td><a href='../controller/router.php?action=changeCondition&controlleur=administrateur&nplaque=%s&emprunteur=%s&datedebut=%s&condition=%s&reservation=gare'>%d</a></td><td>%01.1f</td>"
                    . "</tr>",
