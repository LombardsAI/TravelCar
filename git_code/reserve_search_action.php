...
//        . " p.aeroport ='CDG' AND"
    ...
    $sql = "SELECT aeroport, p.label, adresse,p.n_plaque FROM parking p, "
        . "(SELECT label_du_parking as label FROM gare g WHERE "
       . "unix_timestamp(g.date_debut) < unix_timestamp('" .$info["time_debut"] ."') OR "
//       . "unix_timestamp(g.date_debut)< unix_timestamp('05/08/2019 00:00:00') OR "
...
//        . "unix_timestamp(g.date_fin)> unix_timestamp('05/09/2019 00:00:00'))a WHERE"
        . "(p.aeroport ='" .$info["aeroport"] ."'AND"
//        . " p.aeroport ='CDG' AND"
        . " p.n_plaque NOT IN (SELECT e.n_plaque FROM emprunte e"
        . "WHERE unix_timestamp(e.date_fin) > unix_timestamp('" .$info["time_debut"] ."'))";
